...
{ 
	...
	cout << "There should be " << fileLines << " lines."; // test of the lines counter

	for (int i = 0; i < fileLines; i++)
	{
		cout << init1 << init2 << init3 << setw(12) << posCode << setw(12) << age << setw(12) << dollarsPerHour << setw(12) << payCode;
	}
	return 0;
}
